...
- **[Prompt de migração EAF 9.4.0 → 9.4.3](../../.specs/prompt-migracao-eaf-9.4.0-para-9.4.3.md)**: Prompt para agentes aplicarem o fluxo de registro/aprovação de tenants, edição `Free` e roles padrão em projetos gerados na versão 9.4.0.
