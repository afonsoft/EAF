...
### Instalação via NuGet
```bash
dotnet add package Eaf.KeyVault.AspNetCore --version 9.3.1
```
...
- .NET 10.0 SDK ou superior
- ASP.NET Boilerplate 10.5.0
- Eaf.Middleware.Core 9.3.1

### Instalação via NuGet
```bash
dotnet add package Eaf.Middleware.Application --version 9.3.1
```
...
### Instalação via NuGet
```bash
dotnet add package Eaf.Middleware.AzureActiveDirectory --version 9.3.1
```
...
### Instalação via NuGet
```bash
dotnet add package Eaf.OpenTelemetry --version 9.3.1
```
...
### Instalação via NuGet
```bash
dotnet add package Eaf.SqlServerCache --version 9.3.1
```
