...
export class UserDelegationServiceProxy {
  ...
  getMyDelegations(input: IGetUserDelegationsInput): Observable<IListResultDtoOfUserDelegationDto> {
    ...
    if (input.sourceUserId !== undefined && input.sourceUserId !== null)
      url_ += 'SourceUserId=' + encodeURIComponent('' + input.sourceUserId) + '&';
    if (input.targetUserId !== undefined && input.targetUserId !== null)
      url_ += 'TargetUserId=' + encodeURIComponent('' + input.targetUserId) + '&';
    ...
    return this.http
      ...
      .pipe(_observableMergeMap((response: any) => this.processList(response)))
      .pipe(
  ...
  create(input: ICreateUserDelegationInput): Observable<IUserDelegationDto> {
    ...
    return this.http
      ...
      .pipe(_observableMergeMap((response: any) => this.processUserDelegation(response)))
      .pipe(
        _observableCatch((response: any) => {
          if (response instanceof Error) throw response;
          return _observableThrow(response);
