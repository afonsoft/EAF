...
export class OrganizationUnitServiceProxy {
  ...
  getOrganizationUnits(): Observable<IOrganizationUnitDto[]> {
    ...
    return this.http
      ...
      .pipe(_observableMergeMap((response: any) => this.processOrganizationUnits(response)))
      .pipe(
  ...
  create(input: ICreateOrganizationUnitInput): Observable<IOrganizationUnitDto> {
    ...
    return this.http
      .request('post', url_, options)
      .pipe(_observableMergeMap((response: any) => this.processOrganizationUnit(response)))
      .pipe(
        _observableCatch((response: any) => {
          if (response instanceof Error) throw response;
          return _observableThrow(response);
  ...
  move(input: IMoveOrganizationUnitInput): Observable<void> {
    ...
    return this.http
      .request('post', url_, options)
      .pipe(_observableMergeMap((response: any) => this.processVoid(response)))
      .pipe(
        _observableCatch((response: any) => {
          if (response instanceof Error) throw response;
          return _observableThrow(response);
  ...
  getOrganizationUnitUsers(input: IGetOrganizationUnitUsersInput): Observable<IPagedResultDtoOfOrganizationUnitUserListDto> {
    let url_ =
      this.baseUrl +
      '/api/services/app/OrganizationUnit/GetOrganizationUnitUsers?OrganizationUnitId=' +
      encodeURIComponent('' + input.organizationUnitId) +
      '&';
    ...
    return this.http
      .request('get', url_, options)
      .pipe(_observableMergeMap((response: any) => this.processPagedUsers(response)))
      .pipe(
        _observableCatch((response: any) => {
          if (response instanceof Error) throw response;
          return _observableThrow(response);
  ...
  getOrganizationUnitRoles(input: IGetOrganizationUnitUsersInput): Observable<IPagedResultDtoOfOrganizationUnitRoleListDto> {
    let url_ =
      this.baseUrl +
      '/api/services/app/OrganizationUnit/GetOrganizationUnitRoles?OrganizationUnitId=' +
      encodeURIComponent('' + input.organizationUnitId) +
      '&';
    if (input.filter !== undefined && input.filter !== null) url_ += 'Filter=' + encodeURIComponent('' + input.filter) + '&';
    if (input.sorting !== undefined && input.sorting !== null) url_ += 'Sorting=' + encodeURIComponent('' + input.sorting) + '&';
    ...
    return this.http
      .request('get', url_, options)
      .pipe(_observableMergeMap((response: any) => this.processPagedRoles(response)))
      .pipe(
        _observableCatch((response: any) => {
          if (response instanceof Error) throw response;
          return _observableThrow(response);
