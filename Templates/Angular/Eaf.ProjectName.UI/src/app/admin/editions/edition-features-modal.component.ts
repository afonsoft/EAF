...
import { EditionServiceProxy, INameValueDto, UpdateEditionFeaturesInput, NameValueDto } from '@shared/service-proxies/service-proxies';
...
export class EditionFeaturesModalComponent extends AppComponentBase {
    ...
    save(): void {
        ...
        const input = new UpdateEditionFeaturesInput({ id: this.editionId, featureValues } as any);
