...
import { ICreateMassNotificationInput, IMassNotificationDto, MassNotificationServiceProxy, CreateMassNotificationInput, EntityDtoOfInt64 } from '@shared/service-proxies/service-proxies';
...
export class MassNotificationsComponent extends AppComponentBase implements OnInit {
    ...
    showCreateModal(): void {
        this.newMassNotification = { subject: '', message: '', severity: 0, targetUserIds: undefined, targetRoleIds: undefined, targetOrganizationUnitIds: undefined, sendToAllUsers: false, scheduledTime: undefined };
        this.modal.show();
    }
