...
describe('MassNotificationsComponent', () => {
  ...
  it('should not save without subject and message', () => {
    component.newMassNotification = { subject: '', message: '', severity: 0, targetUserIds: undefined, targetRoleIds: undefined, targetOrganizationUnitIds: undefined, sendToAllUsers: false, scheduledTime: undefined };
    component.save();
