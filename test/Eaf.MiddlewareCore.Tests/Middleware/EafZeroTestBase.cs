...
{
    public abstract class EafMiddlewareTestBase : AbpIntegratedTestBase<EafMiddlewareTestModule>
    {
        protected EafMiddlewareTestBase()
        {
            SeedTestData();
        ...
        {
            LoginAsTenant(Tenant.DefaultTenantName, Abp.Authorization.Users.AbpUserBase.AdminUserName);
        }
        ...
        {
            LoginAsHost(Abp.Authorization.Users.AbpUserBase.AdminUserName);
        }
        ...
        /// <summary>
        /// Gets current user if <see cref="IAbpSession.UserId"/> is not null. Throws exception if
        /// it's null.
        /// </summary>
        ...
        /// <summary>
        /// Gets current tenant if <see cref="IAbpSession.TenantId"/> is not null. Throws exception
        /// if there is no current tenant.
        /// </summary>
