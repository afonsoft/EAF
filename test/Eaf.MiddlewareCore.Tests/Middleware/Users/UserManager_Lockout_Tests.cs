...
{
    public class UserManager_Lockout_Tests : EafMiddlewareTestBase
    {
        ...
        public async Task Test_IsLockoutEnabled_On_User_Creation_Should_Use_Setting_By_Default(bool isLockoutEnabledByDefault)
        {
            ...
            var user = new User
            {
                ...
                //IsLockoutEnabled = isLockoutEnabledByDefault
            };
        ...
        public async Task Test_IsLockoutEnabled_On_User_Creation_Should_Use_Stricter_Value_If_Set(bool isLockoutEnabledByDefault, bool? isLockoutEnabled, bool isLockoutEnabledExpected)
        {
            ...
            var user = new User
            {
                ...
                IsEmailConfirmed = true,
                Password = "AM4OLBpptxBYmM79lGOX9egzZk3vIQU3d/gFCJzaBjAPXzYIK3tQ2N7X4fcrHtElTw==", //123qwe
                IsLockoutEnabled = isLockoutEnabled ?? true,
            };
        ...
        private void ChangeLockoutEnabledSetting(bool isLockoutEnabledByDefault)
        {
            LocalIocManager.Using<ISettingManager>(settingManager =>
            {
                ...
                {
                    settingManager.ChangeSettingForTenant(tenantId, "Abp.Zero.UserManagement.UserLockOut.IsEnabled", isLockoutEnabledByDefault.ToString());
                }
                else
                {
                    settingManager.ChangeSettingForApplication("Abp.Zero.UserManagement.UserLockOut.IsEnabled", isLockoutEnabledByDefault.ToString());
                }
            });
        }
