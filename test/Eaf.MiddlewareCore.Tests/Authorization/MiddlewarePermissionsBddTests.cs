...
{
    /// <summary>
    /// Testes BDD para MiddlewarePermissions seguindo o padrão Dado/Quando/Então
    /// </summary>
    public class MiddlewarePermissionsBddTests
    {
        [Fact]
        public void Dado_PermissoesPaginas_Quando_Verificar_Entao_DevemEstarCorretas()
        {
        ...
        [Fact]
        public void Dado_PermissoesRoles_Quando_Verificar_Entao_DevemEstarCorretas()
        {
        ...
        [Fact]
        public void Dado_PermissoesUsuarios_Quando_Verificar_Entao_DevemEstarCorretas()
        {
        ...
        [Fact]
        public void Dado_PermissoesTenants_Quando_Verificar_Entao_DevemEstarCorretas()
        {
        ...
        [Fact]
        public void Dado_PermissoesAdministracao_Quando_Verificar_Entao_DevemEstarCorretas()
        {
        ...
        [Fact]
        public void Dado_PermissoesIdiomas_Quando_Verificar_Entao_DevemEstarCorretas()
        {
