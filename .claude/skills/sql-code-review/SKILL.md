...
description: 'Use when reviewing SQL code in EAF projects (EF Core, SQL Server, or other SQL backends). Focuses on SQL injection prevention, access control, code standards, and anti-pattern detection.'
metadata:
  version: '1.0.0'
---
