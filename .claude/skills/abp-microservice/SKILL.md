...
license: UNLICENSED
description: 'Use when designing or working with microservices in EAF projects using the ABP microservice solution template or inter-service communication patterns.'
metadata:
  version: '1.0.0'
---
