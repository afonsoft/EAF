...
- **Testes API Template**: 212 total, 69 passando, 142 falhando (problema pré-existente de EF Core)
...
| **Falhando** | 142 |
| **Ignorados** | 1 |
| **Problema Conhecido** | Configuração concorrente de EF Core DbContext (pré-existente) |
