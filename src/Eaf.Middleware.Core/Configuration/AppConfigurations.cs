...
namespace Eaf.Middleware.Configuration
{
    ...
    public static class AppConfigurations
    {
        ...
        public static IConfigurationRoot Get(string path, string environmentName = null, bool addUserSecrets = false)
        {
            ...
            Environment.SetEnvironmentVariable("DOTNET_ENVIRONMENT", environmentName.Trim());
            Environment.SetEnvironmentVariable("ASPNETCORE_ENVIRONMENT", environmentName.Trim());
            Environment.SetEnvironmentVariable("EAF_ENVIRONMENT", environmentName.Trim());
            Environment.SetEnvironmentVariable("ASPNET_ENV", environmentName.Trim());
