...
namespace Eaf.Middleware.OrganizationUnits
{
    /// <summary>
    /// Serviço de aplicação para gerenciamento de unidades organizacionais.
    /// </summary>
    [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : MiddlewareAppServiceBase, IOrganizationUnitAppService
    {
        ...
        /// </summary>
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits_Create)]
        ...
        /// </summary>
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits_Edit)]
        ...
        /// </summary>
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits_Delete)]
        ...
        /// </summary>
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits_ManageMembers)]
        ...
        /// </summary>
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_OrganizationUnits_ManageRoles)]
