...
namespace Eaf.Middleware.Auditing
{
    ...
    public class AuditLogAppService : MiddlewareAppServiceBase, IAuditLogAppService
    {
        ...
        /// <param name="auditLogListExcelExporter">Parâmetro auditLogListExcelExporter.</param>
        /// <param name="namespaceStripper">Parâmetro namespaceStripper.</param>
        /// <param name="entityChangeRepository">Parâmetro entityChangeRepository.</param>
        /// <param name="entityChangeSetRepository">Parâmetro entityChangeSetRepository.</param>
        ...
        public List<NameValueDto> GetEntityHistoryObjectTypes()
        {
            ...
            var entityHistoryConfig = _eafStartupConfiguration.GetCustomConfig();
            entityHistoryConfig = entityHistoryConfig.ToDictionary(key => key.Key, value => value.Value);
        ...
        /// </summary>
        /// <param name="entityChangeId">Parâmetro entityChangeId.</param>
        /// <returns>Resultado da operação.</returns>
        public async Task<List<EntityPropertyChangeDto>> GetEntityPropertyChanges(long entityChangeId)
        {
            return await _entityPropertyChangeRepository.GetAll()
                ...
                {
                    EntityChangeId = x.EntityChangeId,
                    Id = x.Id,
                    NewValue = x.NewValue,
