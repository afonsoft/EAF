...
namespace Eaf.Middleware.Localization
{
    ...
    public class LanguageAppService : MiddlewareAppServiceBase, ILanguageAppService
    {
        ...
        /// LanguageAppService.
        /// </summary>
        /// <param name="applicationLanguageManager">Parâmetro applicationLanguageManager.</param>
        /// <param name="applicationLanguageTextManager">Parâmetro applicationLanguageTextManager.</param>
        /// <param name="languageRepository">Parâmetro languageRepository.</param>
        ...
        /// <param name="input">Parâmetro input.</param>
        /// <returns>Resultado da operação.</returns>
        public async Task<GetLanguagesOutput> GetLanguages(GetLanguagesInput input)
        {
            var languages = (await _applicationLanguageManager.GetLanguagesAsync(AbpSession.TenantId))
                .AsQueryable()
                .WhereIf(!input.Filter.IsNullOrWhiteSpace(), t => t.Name.Contains(input.Filter) || t.DisplayName.Contains(input.Filter))
        ...
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_Languages_ChangeTexts)]
        ...
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_Languages_Create)]
        ...
        [AbpAuthorize(MiddlewarePermissions.Pages_Administration_Languages_Edit)]
