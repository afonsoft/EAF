...
{
    /// <summary>
    /// Representa a classe PermissionManagerExtensions.
    /// </summary>
    public static class PermissionManagerExtensions
    {
        /// <summary>
        /// Gets all permissions by names. Throws <see cref="AbpValidationException"/> if can not
        /// find any of the permission names.
        /// </summary>
